...
new_layer: 
	...
	nvcc --compile src/layer/new_layer/GPU_utils.cu -o src/layer/new_layer/GPU_utils.cu.o -I./ -L/usr/local/cuda/lib64 -lcudart 
	nvcc --compile src/layer/new_layer/GPU_new_forward_optimazed.cu -o src/layer/new_layer/GPU_new_forward_optimazed.o -I./ -L/usr/local/cuda/lib64 -lcudart 
